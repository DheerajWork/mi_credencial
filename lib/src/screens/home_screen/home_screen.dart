...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: cardList.isEmpty?const Center(
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  Image.asset(MyImages.logo2),
                  const Spacer(),
                  Image.asset(MyImages.user),
                  const SizedBox(
                    width: 15,
                  ),
                  GestureDetector(
                      ...
                      child: Image.asset(MyImages.menuIcon)),
                ],
              ),
            ),
            Expanded(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: MyStyles.gray15Small.copyWith(height: 1.2),
              ),
            ),
            const SizedBox(
              height: 30,
